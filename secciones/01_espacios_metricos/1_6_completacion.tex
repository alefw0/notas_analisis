\section{Completacion de un espacio metrico}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Como $d(a_n,a_n)=0$ para todo $n\in\ene$, entonces $\{a_n\}\sim\{a_n\}$.
        \item Como $d(a_n,b_n)=d(b_n,a_n)$ para todo $n\in\ene$, se sigue la simetría.
    ...
    Probemos que $\rho$ está bien definida. Sean $\{a_n\}$ y $\{b_n\}$ sucesiones de Cauchy en $X$. Sea $x_n:=d(a_n,b_n)$. Afirmamos que $\{x_n\}$ es de Cauchy en $\R$. En efecto, para todo $m,n\in\ene$,
    \[
    ...
    Veamos que $\rho$ es una métrica. Las propiedades de positividad, identidad e invariancia por intercambio se heredan de $d$. Para la triangular, para todo $n\in\ene$,
    \[
