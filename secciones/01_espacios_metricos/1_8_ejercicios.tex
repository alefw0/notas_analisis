...
\begin{enumerate}
    ...
    \item Establezca la convergencia o divergencia de la sucesión $\{x_n\}$ en $\R$ o $\R^2$ definida para $n \in \Z^+$ como:
    \begin{enumerate}
        \item[a)] $x_n = \frac{1}{n}$.
...
\vspace{0.5cm}
En los siguientes ejercicios $(X, d)$ denotará un espacio métrico arbitrario. En algunos casos éste denotará algún espacio particular el cual se especificará explícitamente. Tenga en cuenta las siguientes definiciones:
